        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.Employees)
                ...
                .HasConstraintName("FK_Employee_Department");
                 ...
                 entity.HasMany(e => e.EmployeeEducationInfos)
                .WithOne(ei => ei.Employee)
                .HasForeignKey(ei => new { ei.IdClient, ei.IdEmployee }) // If composite key is needed
                .OnDelete(DeleteBehavior.Cascade);




                entity.HasMany(e => e.EmployeeDocuments)
                .WithOne(ei => ei.Employee)
                .HasForeignKey(ei => new { ei.IdClient, ei.IdEmployee }) // If composite key is needed
                .OnDelete(DeleteBehavior.Cascade);
                ...
                entity.HasMany(e => e.EmployeeFamilyInfos)
                .WithOne(ei => ei.Employee)
                .HasForeignKey(ei => new { ei.IdClient, ei.IdEmployee }) // If composite key is needed
                .OnDelete(DeleteBehavior.Cascade);


                entity.HasMany(e => e.EmployeeProfessionalCertifications)
                  .WithOne(ei => ei.Employee)
                  .HasForeignKey(ei => new { ei.IdClient, ei.IdEmployee }) // If composite key is needed
                  .OnDelete(DeleteBehavior.Cascade);
